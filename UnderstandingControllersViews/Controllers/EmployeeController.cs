...
namespace UnderstandingControllersViews.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Detail(int id, string name)
        {
            ...
            emp.Address = "Grodno, BY";
            return View(emp);
        }

        public string TotalSalary(int totalEmployees, int averageSalary)
        {
            string total = "Total Salary of all Employees: $" + (totalEmployees * averageSalary);
            return total;
        }
    }
}
